\chapter{Theoretische Grundlagen}
   ...
   Wie Figuren sich bewegen und andere Figuren schlagen erkläre ich nicht explizit, lediglich zwei Sonderregeln des Schachs werde ich genauer erklären, da diese bei der Umsetzung des Spiels gesondert gehandhabt werden müssen.
...
\end{figure}
  ...
  \begin{figure}[h!]
  \centering
  \includegraphics[width=120mm]{Middleware-Beispiel.jpg}
  
  \vspace{20mm}
  
  \includegraphics[width=120mm]{Middleware-Beispiel-2.jpg}
