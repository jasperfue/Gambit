...
In diesem Beispiel implementieren wir die Komponente \textit{ExampleComponent}, welche beispielsweise mittels dem Tag \\ \verb|<ExampleComponent initialCount={10} loadingDelay={3000} />| verwendet werden kann. 
