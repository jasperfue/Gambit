...
const PromotionModal = (props) => {
    ...
    const [queen, setQueen] = useState(props.colour === 'white'
    ...
    const [bishop, setBishop] = useState(props.colour === 'white'
    ...
    const [knight, setKnight] = useState(props.colour === 'white'
    ...
    const [rook, setRook] = useState(props.colour === 'white'
