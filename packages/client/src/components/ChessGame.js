...
const ChessGame = () => {
    ...
    const [colour, setColour] = useState(location.state.playerColourIsWhite === true ? "white" : "black");
    ...
    const queen = location.state.playerColourIsWhite === true ?
    ...
    const bishop = location.state.playerColourIsWhite === true ?
    ...
    const knight = location.state.playerColourIsWhite === true ?
    ...
    const rook = location.state.playerColourIsWhite === true ?
    ...
    function onMove() {
        return (orig, dest) => {
            if(((colour === 'white' && dest.includes('8')) || (colour === 'black' && dest.includes('1'))) && chess.get(orig).type == 'p') { //Promotion
            ...
            :
                ...
                <div style={{display: "flex", flexDirection:"row", alignItems:"center"}}>
                    ...
                    <div style={{margin: '10VH'}}>
                        <ReactChessClock time={location.state.time} orientation={colour} socket={socket}/>
                    </div>
                </div>
